...
if($results){
    echo '<div class="alert alert-danger">This username is already taken</div>'; exit;
}
...
$results = mysqli_num_rows($result);
if($results){
    echo '<div class="alert alert-danger">This email is already taken</div>'; exit;
}
...
$message .= "http://localhost/Projects/10.Online%20Notes%20App/6.activate.php?email=" . urlencode($email) . "&key=$activationkey";
mail($email, 'Confirm your registration', $message, 'From:' . 'abelgeorgewilsom796@gmail.com');
